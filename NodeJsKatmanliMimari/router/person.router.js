...
router.post('/updateCv', [personValidatior.personValidatior.validateUpdateCv()], controller.personController.updateCv)
router.post('/uploadAvatar', [personValidatior.personValidatior.validateUploadAvatar()], controller.personController.uploadAvatar)
router.post('/updateAvatar', [personValidatior.personValidatior.validateUpdateAvatar()], controller.personController.updateAvatar)
...
router.post('/signIn',[personValidatior.personValidatior.validateSignIn()], controller.personController.signIn)
module.exports = {
    person: router
}